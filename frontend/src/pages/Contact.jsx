        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-8">
              ...
              <a href="https://wa.me/919155936229" className="flex items-center px-6 py-3 bg-green-500 text-white rounded-full shadow-sm hover:shadow-md transition-all duration-300">
