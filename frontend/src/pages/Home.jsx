            ...
            {[
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  <h3 className="text-white font-bold text-2xl mb-4 text-center px-4">
                    {category.name}
                  </h3>
                  <span className="px-6 py-2 bg-white text-orange-600 rounded-full font-semibold text-sm opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                    VIEW PRODUCTS
                  </span>
                </div>
              </Link>
