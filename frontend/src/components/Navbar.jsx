          ...
          <div className="relative group">
            {token ? (
              <div className="flex flex-row items-center">
                <img
                  className="w-5 small_mobile:w-6 h-5 small_mobile:h-6 rounded-full cursor-pointer border-2 border-transparent transition-all duration-300 group-hover:border-black"
            ...
            {token && (
              <div className="absolute dropdown-menu right-0 pt-4 z-10 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 transform origin-top-right">
                <div className="w-56 py-4 px-5 bg-white shadow-lg rounded-md border border-gray-200">
                  ...
                  <div className="flex flex-col gap-3 text-gray-700">
                    <Link to="/profile" className="flex items-center gap-2 hover:text-black transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                      </svg>
                      <span>My Profile</span>
                    </Link>
                    <Link to="/orders" className="flex items-center gap-2 hover:text-black transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
                      </svg>
                      <span>My Orders</span>
                    </Link>
                    <Link to="/wishlist" className="flex items-center gap-2 hover:text-black transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                      </svg>
                      <span>Wishlist</span>
                    </Link>
                    <Link to="/settings" className="flex items-center gap-2 hover:text-black transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex-1 overflow-y-auto">
            <div className="flex flex-col py-4">
              <NavLink
                onClick={() => setVisible(false)}
                className={({ isActive }) => 
                  `py-3 px-6 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200 ${isActive ? 'font-semibold' : ''}`
                }
                to="/"
              >
                HOME
              ...
              {token ? (
                <>
                  ...
                  <NavLink
                    onClick={() => setVisible(false)}
                    className="py-3 px-6 border-b border-gray-100 hover:bg-gray-50 transition-colors duration-200"
                    to="/profile"
                  >
                    My Profile
                  </NavLink>
                ...
                <Link
                  onClick={() => setVisible(false)}
                  to="/login"
                  className="mx-6 mt-6 bg-black text-white py-3 rounded text-center hover:bg-gray-800 transition-colors duration-200"
                >
                  Login / Sign Up
                </Link>
              )}
