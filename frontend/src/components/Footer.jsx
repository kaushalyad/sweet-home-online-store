        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              At <span className="font-semibold text-pink-500">Sweet Home</span>
            ...
            <Link
              to="/about"
              className="inline-block text-black font-semibold hover:text-pink-500 transition-colors duration-200"
            >
              Learn more about us →
            </Link>
            ...
            <div className="flex gap-3 mt-4">
              <a
                href="#"
                className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center text-gray-600 hover:bg-pink-500 hover:text-white transition-colors duration-300"
              >
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  Nearby PNB BANK, Main Road JaiNagar, Ladania - 110001
                </span>
              </li>
              <li className="flex items-center">
                <FaPhoneAlt className="text-pink-500 mr-3" />
                <a
                  href="tel:+919931018857"
            ...
            <Link
              to="/contact"
              className="inline-block mt-4 bg-pink-50 hover:bg-pink-100 text-gray-800 px-4 py-2 rounded-md transition-colors duration-200 border border-pink-100"
            >
              Send us a message →
            </Link>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              ...
              <div className="flex gap-2 mt-2">
                ...
                <div className="bg-white p-1.5 rounded shadow-sm border border-gray-100">
                  <img
                    src="https://cdn-icons-png.flaticon.com/128/196/196559.png"
                ...
                <div className="bg-white p-1.5 rounded shadow-sm border border-gray-100">
                  <img
                    src="https://cdn-icons-png.flaticon.com/128/8677/8677548.png"
                    alt="RazorPay"
                    className="h-6"
                  />
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-center items-center text-center">
            <p className="text-sm text-gray-600">
              &copy; {new Date().getFullYear()} Sweet Home Store. All Rights
              Reserved.
            </p>
            <span className="hidden md:inline-block mx-2">•</span>
            <p className="text-sm text-gray-600">
              Designed with <span className="text-pink-500">♥</span> for sweet
              lovers
            </p>
          </div>
        </div>
